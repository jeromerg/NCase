...
namespace NUtil.Doc
{
    ...
    public class ConsoleMirroring : TextWriter
    {
        ...
        public override Encoding Encoding { get { return mConsoleOutput.Encoding; } }
        public override IFormatProvider FormatProvider { get { return mConsoleOutput.FormatProvider; } }
        public override string NewLine { get { return mConsoleOutput.NewLine; } set { mConsoleOutput.NewLine = value; } }
